...
<body
	style="background-image: linear-gradient(to right, #399751, #5faf4c, #8ac642, #badc34, #f0ef23); bakcgound-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
